<?php
// source: C:\wamp64\www\seznam.cz\app/config/config.neon 
// source: C:\wamp64\www\seznam.cz\app/config/config.local.neon 

class Container_719ccbb295 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\wamp64\www\seznam.cz\app',
			'wwwDir' => 'C:\wamp64\www\seznam.cz\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\wamp64\www\seznam.cz\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory()
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\wamp64\www\seznam.cz\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\seznam.cz\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp64\www\seznam.cz\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_719ccbb295_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_719ccbb295_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_719ccbb295 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\wamp64\www\seznam.cz\app/../temp/cache/latte');
